...
#CRIA UM NOVO DIREOTIO PARA O PROJETO ANGULAR
ng new my-app

#MAPEIA O VOLUME DO PROJETO PARA O CONTAINER DO NGINX
docker run -v "C:\\_DEV\Fase 1 - Fundamentos - Imagens e Continers\\Aula 7 - Angular\\dist\\app"://usr//share//nginx/html -p 8083:80 nginx